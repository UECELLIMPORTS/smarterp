  ...
  return (
    ...
    >
      ...
      >
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="balanco" style={{ color: '#F59E0B', background: '#0E3A30' }}>⚖ Balanço</option>
              </select>
        ...
        {/* Footer */}
        <div className="flex gap-3 border-t px-5 py-4" style={{ borderColor: '#1F5949' }}>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <div className="rounded-xl border p-4" style={{ background: '#15463A', borderColor: '#1F5949' }}>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: '#86EFAC' }}>
              Entradas
            </span>
          </div>
      ...
      >
        ...
        {rows.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-3 py-20">
            <CalendarClock className="h-10 w-10" style={{ color: '#5EC2A0' }} />
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-right tabular-nums text-text">
                    {recalcing
                      ? <span className="inline-block h-4 w-10 animate-pulse rounded" style={{ background: '#1F5949' }} />
