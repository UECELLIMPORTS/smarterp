  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <KPI label="Lucro" value={BRL(data.totalProfitCents)} icon={TrendingUp} color="#A855F7" />
              ...
              <tbody>
                {data.rows.map(r => (
                  <tr key={r.id} className="border-t hover:bg-white/[0.02] transition-colors"
                    ...
                    <Td>{r.customerName ?? <span className="italic" style={{ color: '#A78BFA' }}>—</span>}</Td>
                    <Td>
                    ...
                    <Td>
                      <span className="rounded px-1.5 py-0.5 text-[10px] font-bold"
                        style={{
                          background: `${STATUS_COLOR[r.status] ?? '#A78BFA'}18`,
                          color: STATUS_COLOR[r.status] ?? '#A78BFA',
                        }}>
                    ...
                    <Td align="right" mono
                      color={r.profitCents > 0 ? '#10B981' : r.profitCents < 0 ? '#EF4444' : '#A78BFA'}>
                      {BRL(r.profitCents)}
                    </Td>
                  </tr>
                ))}
              ...
              <tfoot style={{ background: '#2A2440' }}>
                <tr>
                  <Td colSpan={6}><span className="font-bold uppercase text-[10px] tracking-wider"
                    style={{ color: '#A78BFA' }}>Totais (excl. canceladas)</span></Td>
                  ...
                  <Td align="right" mono bold color="#A855F7">{BRL(data.totalProfitCents)}</Td>
                </tr>
              </tfoot>
            </table>
          </div>
