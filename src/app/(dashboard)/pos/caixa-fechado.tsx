      ...
      {lastSummary && (
        <div className="rounded-2xl border p-5"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            ...
            <KPI label="Em dinheiro" value={BRL(lastSummary.cashSalesCents)} icon={DollarSign} color="#A855F7" />
            ...
            <div className="rounded-lg border p-3 mb-4"
              style={{
                background: lastSummary.differenceCents === 0 ? 'rgba(16,185,129,.06)'
                  : lastSummary.differenceCents > 0 ? 'rgba(168,85,247,.06)'
                  : 'rgba(255,77,109,.06)',
                borderColor: lastSummary.differenceCents === 0 ? '#10B981'
                  : lastSummary.differenceCents > 0 ? '#A855F7'
                  : '#EF4444',
              }}>
          ...
          {lastSummary.breakdown.length > 0 && (
            <div>
              <p className="text-[11px] font-bold uppercase tracking-wider mb-2" style={{ color: '#A78BFA' }}>
                ...
                {lastSummary.breakdown.map(b => (
                  <div key={b.paymentMethod}
                    ...
                    <span style={{ color: '#F8FAFC' }}>
                      ...
                      <span style={{ color: '#A78BFA' }}> · {b.count} {b.count === 1 ? 'venda' : 'vendas'}</span>
                    </span>
          ...
          <p className="text-[10px] mt-4" style={{ color: '#A78BFA' }}>
