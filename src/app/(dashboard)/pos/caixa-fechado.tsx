      ...
      {lastSummary && (
        <div className="rounded-2xl border p-5"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            ...
            <KPI label="Em dinheiro" value={BRL(lastSummary.cashSalesCents)} icon={DollarSign} color="#1D4ED8" />
            <KPI label="Esperado no caixa" value={BRL(lastSummary.expectedCashCents)} icon={CreditCard} color="#475569" />
          </div>
            ...
            <div className="rounded-lg border p-3 mb-4"
              style={{
                background: lastSummary.differenceCents === 0 ? 'rgba(16,185,129,.06)'
                  : lastSummary.differenceCents > 0 ? 'rgba(29,78,216,.06)'
                  : 'rgba(255,77,109,.06)',
                borderColor: lastSummary.differenceCents === 0 ? '#10B981'
                  : lastSummary.differenceCents > 0 ? '#1D4ED8'
                  : '#EF4444',
              }}>
                ...
                {lastSummary.breakdown.map(b => (
                  <div key={b.paymentMethod}
                    ...
                    <span style={{ color: '#0F172A' }}>
                      ...
                      <span style={{ color: '#64748B' }}> · {b.count} {b.count === 1 ? 'venda' : 'vendas'}</span>
                    </span>
