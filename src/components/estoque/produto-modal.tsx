      ...
      <div className="relative w-full max-w-2xl rounded-2xl border my-8"
        ...
        {isClone && (
          <div className="border-b px-6 py-3 text-xs flex items-center gap-2"
            style={{ borderColor: '#3D3656', background: '#10B98110', color: '#10B981' }}>
        ...
        {/* Dados fixos no topo */}
        <div className="border-b px-6 py-4 space-y-4" style={{ borderColor: '#3D3656' }}>
          {error && (
        ...
        {/* Abas */}
        <div className="border-b flex" style={{ borderColor: '#3D3656' }}>
          {TABS.map(t => (
          ...
          {tab === 'Estoque' && (
            <>
              ...
              {form.stockMax > 0 && form.stockQty > form.stockMax && (
                <div className="rounded-lg px-3 py-2 text-xs flex items-center gap-2"
                  style={{ background: '#C084FC18', color: '#60A5FA', border: '1px solid #C084FC40' }}>
                  <AlertTriangle className="h-3.5 w-3.5 shrink-0" />
